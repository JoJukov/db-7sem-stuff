...
COPY role (role_id, name)
from 'C:\Users\Ivan\db\lab2\role.csv'
DELIMITER ','
CSV HEADER;

COPY permission (permission_id, name)
from 'C:\Users\Ivan\db\lab2\permission.csv'
DELIMITER ','
CSV HEADER;

COPY library_user (library_user_id, role_id, email, name, phone,address)
from 'C:\Users\Ivan\db\lab2\library_user.csv'
DELIMITER ','
CSV HEADER;


COPY role_permission (role_id ,permission_id)
from 'C:\Users\Ivan\db\lab2\role_permission.csv'
DELIMITER ','
CSV HEADER;

COPY shopping_cart (shopping_cart_id, library_user_id)
from 'C:\Users\Ivan\db\lab2\shopping_cart.csv'
DELIMITER ','
CSV HEADER;

COPY publisher (publisher_id, name,phone, address,url, contact_email)
from 'C:\Users\Ivan\db\lab2\publisher.csv'
DELIMITER ','
CSV HEADER;
